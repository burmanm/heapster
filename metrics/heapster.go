...
var (
	...
	argSinks            flags.Uris
	argHistoricalSource = flag.String("historical_source", "", "which source type to use for the historical API (should be exactly the same as one of the sink URIs)")
)
...
func main() {
	...
	if historicalSource == nil && argHistoricalSource != nil {
